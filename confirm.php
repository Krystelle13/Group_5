...
// COUNT ONLY PAID / READY FOR CONFIRMATION
$pCount = $conn->query("SELECT COUNT(*) FROM bookings WHERE status LIKE '%Paid%'")->fetchColumn();
?>
...
<head>
    <meta charset="UTF-8">
    <title>Confirm Payment | Island Aura</title>
    ...
    <style>
        ...
        .badge-notif { background: #28a745; color: white; padding: 2px 10px; border-radius: 50px; font-size: 14px; }
...
<div class="main-content">
    ...
    <div class="card p-4 border-start border-success border-5">
        <h5 class="text-success fw-bold mb-3">Ready for Payment Confirmation</h5>
